			...
			<div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        <a href="{{ route('corporate_admin.owner.create') }}" class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Owner</a>
                    </div>
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Total Owners</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $totalUsers }} Owners</h3>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form action="{{ route('corporate_admin.owner.destroy', $user->user_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?')">
                                                        @csrf
                                                        @method('DELETE')
