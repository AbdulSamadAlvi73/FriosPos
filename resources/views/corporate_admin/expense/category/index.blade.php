			...
			<div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        <a href="{{ route('corporate_admin.expense-category.create') }}" class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Sub category</a>
                    </div>
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Total Sub Categories</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $expenseSubCategoryCount }} Sub Categories</h3>
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive rounded">
                            <table id="example5" class="table customer-table display mb-4 fs-14 card-table">
                                ...
                                <tbody>
                                    @foreach ($expenseSubCategories as $index => $expenseSubCategory)
                                    <tr>
                                        <td>
                                            <div class="form-check checkbox-secondary">
                                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault{{ $expenseSubCategory->id }}">
                                                <label class="form-check-label" for="flexCheckDefault{{ $expenseSubCategory->id }}"></label>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('corporate_admin.expense-category.edit', $expenseSubCategory->id) }}" class="edit-expenseSubCategory">
                                                ...
                                                <form action="{{ route('corporate_admin.expense-sub-category.delete', $expenseSubCategory->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Sub Category?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="ms-4 delete-expenseSubCategory">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
