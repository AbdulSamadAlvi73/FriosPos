    ...
    <div class=" content-body default-height">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="row">
                        @if (auth()->user()->role == 'franchise_manager' || auth()->user()->role == 'franchise_staff')
            ...
            <div class="me-3">
                ...
                <div>
                    <p class="text-primary fs-14 mb-0">
                        <svg class="me-2 primary-icon" width="19" height="12" viewBox="0 0 19 12" fill="none"
                            xmlns=	"http://www.w3.org/2000/svg">
                            <path
                                d="M2.00401 11.1924C0.222201 11.1924 -0.670134 9.0381 0.589795 7.77817L7.78218 0.585786C8.56323 -0.195262 9.82956 -0.195262 10.6106 0.585786L17.803 7.77817C19.0629 9.0381 18.1706 11.1924 16.3888 11.1924H2.00401Z"
                                fill="#0E8A74" />
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-footer pt-0 border-0">
                    <a href="javascript:void(0);" class="btn btn-secondary btn-block text-white dz-load-more"
                        id="UpcomingEvent" rel="page-error-404.html">Load More</a>
                </div>
            </div>
        </div>
    </div>
