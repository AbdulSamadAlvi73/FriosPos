                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Total Expenses</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $expenseCount }} Expenses</h3>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <table id="example5" class="table customer-table display mb-4 fs-14 card-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check checkbox-secondary">
                                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault{{ $expense->id }}">
                                                <label class="form-check-label" for="flexCheckDefault{{ $expense->id }}"></label>
                                            </div>
                                        </td>
                                        <td>{{ $expense->name }}</td>
