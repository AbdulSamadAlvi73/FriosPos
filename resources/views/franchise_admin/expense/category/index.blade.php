                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form action="{{ route('franchise.expense-sub-category.delete', $expenseSubCategory->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Sub Category?')">
                                                    @csrf
                                                    @method('DELETE')
