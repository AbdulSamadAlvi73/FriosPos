			...
			<div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        ...
                        <a href="{{ route('franchise_admin.staff.create') }}" class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Staff</a>
                        @endrole
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                @role('franchise_admin')
                                                <div class="d-flex">
                                                    <a href="{{ route('franchise_admin.staff.edit', $user->user_id) }}" class="edit-user">
                                                    ...
                                                    <form action="{{ route('franchise_admin.staff.destroy', $user->user_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?')">
                                                        @csrf
                                                        @method('DELETE')
