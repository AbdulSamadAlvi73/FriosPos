        ...
        <div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        <a href="{{ route('franchise.locations.create') }}" class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Location</a>
                    </div>
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Total Locations</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $locationCount }} Locations</h3>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    @forelse($locations as $location)
                                        <tr>
                                            ...
                                            <td>
                                               <div class="d-flex">
                                                 <a href="{{ route('franchise.locations.edit', $location->locations_ID) }}" >
                                                ...
                                                <form action="{{ route('franchise.locations.destroy', $location->locations_ID) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Location?')">
                                                    @csrf
                                                    @method('DELETE')
