...
<style>
  ...
  </style><div class="content-body default-height">
        <!-- row -->
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function renderFlavors() {
                ...
                popFlavors.forEach((flavor) => {
                    ...
                    div.innerHTML = `<img src="${flavor.image1}" alt="${flavor.name}" class="flavor-img" onerror="this.onerror=null; this.src='https://www.google.com/url?sa=i&url=https%3A%2F%2Fdepositphotos.com%2Fvectors%2F404-text-in-square.html&psig=AOvVaw1EmOTGi0XGLKa-tTvEhtnB&ust=1744996075266000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCJijg4zH34wDFQAAAAAdAAAAABAE'"> ${flavor.name} (${flavor.available})`;
            ...
            function updateFlavorButtons() {
                document.querySelectorAll(".flavor-item").forEach((div) => {
                    ...
                    div.innerHTML =
                        `<img src="${flavor.image1}" alt="${flavor.name}" class="flavor-img"> ${flavor.name} (${flavor.available})`;
