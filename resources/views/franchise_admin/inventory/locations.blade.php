...
@section('content')
    ...
    <script>
      ...
      `;
            ...
            <td>
              <button class="btn btn-outline-warning btn-sm remove-btn" data-location="${allocation.location}" data-flavor="${allocation.flavor}">
              ...
              <button class="btn btn-outline-danger btn-sm sell-btn" data-location="${allocation.location}" data-flavor="${allocation.flavor}">
                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
