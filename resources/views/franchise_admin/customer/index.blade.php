                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ route('franchise.customer.edit', $customer->customer_id) }}" class="ms-4 edit-customer">
                                                ...
                                                <form action="{{ route('franchise.customer.delete', $customer->customer_id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Customer?')">
                                                    @csrf
                                                    @method('DELETE')
